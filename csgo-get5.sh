...
cd /home/csgoserver
sudo -i -u csgoserver aria2c -x3 http://files.e-sports.lu/serverfiles.tar.gz http://retake.e-sports.lu/serverfiles.tar.gz http://multi.e-sports.lu/serverfiles.tar.gz
